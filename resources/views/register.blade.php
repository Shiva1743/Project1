          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                @endif
                <form class="mx-1 mx-md-4" id="registerform" action="{{route('Register')}}" method="post">
                  @csrf
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-group col-md-8">
                      <input type="password" name="confirmpassword" id="confirmpassword" placeholder="Repeat Your Password" class="form-control" />
                    </div>
                  </div>
                  {{-- <label class="d-flex flex-row align-items-center mb-4 error">{{ $errors->first('confirmpassword') }}</label> --}}
